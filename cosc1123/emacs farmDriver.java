...
{
    public static void farmDriver(String[]args)
    {
	...
	switch(choice)
		...
		System.out.println("getFarmInfo");
		System.out.println("ask for file name/name of barn, or New create a new barn");
		System.out.println("get horses from barn");
		System.out.println("call farmMenu");
		System.out.println("choices logic for the farmMenu");
		break;
